...
| find 1 solution   | magic sequence      | 100          | choco(AC, ff)                              | 168            |
| find 1 solution   | magic sequence      | 200          | choco(AC, ff)                              | 361            |
| find 1 solution   | magic sequence      | 300          | choco(AC, ff)                              | 939            |
| find 1 solution   | magic sequence      | 400          | choco(AC, ff)                              | 2167           |
| find 1 solution   | magic sequence      | 100          | nucs(BC, ff)                               | 407            |
| find 1 solution   | magic sequence      | 200          | nucs(BC, ff)                               | 661            |
| find 1 solution   | magic sequence      | 300          | nucs(BC, ff)                               | 1359           |
| find 1 solution   | magic sequence      | 400          | nucs(BC, ff)                               | 2671           |
| find 1 solution   | magic sequence      | 100          | nucs(BC, ff, 1 extra redundant constraint) | 422            |
| find 1 solution   | magic sequence      | 200          | nucs(BC, ff, 1 extra redundant constraint) | 586            |
| find 1 solution   | magic sequence      | 300          | nucs(BC, ff, 1 extra redundant constraint) | 1020           |
| find 1 solution   | magic sequence      | 400          | nucs(BC, ff, 1 extra redundant constraint) | 1856           |
