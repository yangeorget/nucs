...
from nucs.propagators.propagators import ALG_MIN_GEQ, compute_domains
...
class TestMinGEQ:
    ...
    def test_compute_domains_2(self) -> None:
        ...
        data = new_data_by_values([])
        assert compute_domains(ALG_MIN_GEQ, domains, data) == PROP_INCONSISTENCY
    ...
    def test_compute_domains_4(self) -> None:
        ...
        data = new_data_by_values([])
        assert compute_domains(ALG_MIN_GEQ, domains, data) == PROP_ENTAILMENT
