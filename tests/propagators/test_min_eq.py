...
from ncs.memory import new_data_by_values, new_domains_by_values, PROP_CONSISTENCY, PROP_INCONSISTENCY
from ncs.propagators.propagators import ALG_MIN_EQ, compute_domains
