...
class TestQueens:
    ...
    def test_queens_2_solve(self) -> None:
        ...
        solver.solve_all()
        assert solver.statistics[STATS_SOLVER_SOLUTION_NB] == 0
    ...
    def test_queens_4_solve(self) -> None:
        ...
        solver.solve_all()
        assert solver.statistics[STATS_SOLVER_SOLUTION_NB] == 2
    ...
    def test_queens_9_solve_ff(self) -> None:
        ...
        solver.solve_all()
        assert solver.statistics[STATS_SOLVER_SOLUTION_NB] == 352
