...
class TestGolomb:
    ...
    def test_golomb_4_filter(self) -> None:
        ...
        problem.shr_domains_backup[0] = 1
        problem.shr_domains_backup[1] = 4
        problem.shr_domains_backup[2] = 6
        problem.shr_domains_backup[3] = 3
        problem.shr_domains_backup[4] = 5
        problem.shr_domains_backup[5] = 2
