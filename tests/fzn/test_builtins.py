...
class TestBuiltins:
    def test_build_model_mapping_propagators(self) -> None:
        model = build_model(
            parse(
                "var 0..9: x;\nvar 0..9: y;\n"
    ...
    def test_build_model_unit_coefficient_linear_routes_to_sum(self) -> None:
    ...
    def test_build_model_negative_unit_coefficient_linear_routes_to_sum(self) -> None:
    ...
    def test_build_model_arity_one_reified_linear_needs_no_auxiliary_sum(self) -> None:
    ...
    def test_build_model_arity_one_half_reified_linear_needs_no_auxiliary_sum(self) -> None:
        model = build_model(
            parse(
                "var 0..9: x;\nvar bool: p;\nvar bool: q;\n"
    ...
    def test_solve_fzn_arity_one_reified_linear_semantics(self, constraint: str, expected: list) -> None:
    ...
    def test_build_model_int_eq_against_a_constant_uses_the_dedicated_equality(self) -> None:
    ...
    def test_build_model_aliasing_is_transitive(self) -> None:
        model = build_model(
            parse(
                "var 0..9: x;\nvar 0..9: y;\nvar 0..9: z;\n"
    ...
    def test_build_model_aliasing_intersects_domains(self) -> None:
    ...
    def test_build_model_aliasing_intersects_non_contiguous_domains(self) -> None:
    ...
    def test_build_model_disjoint_domains_are_not_aliased(self) -> None:
    ...
    def test_solve_fzn_disjoint_domains_stay_unsatisfiable(self) -> None:
        assert "=====UNSATISFIABLE=====" in solve_fzn(
            "var 0..3: x;\nvar 5..9: y;\nconstraint int_eq(x, y);\nsolve satisfy;"
        )

    def test_solve_fzn_aliased_variables_both_print_in_their_own_type(self) -> None:
    ...
    def test_solve_fzn_aliasing_preserves_the_solution_set(self) -> None:
        out = solve_fzn(
    ...
    def test_build_model_bool_not_uses_the_unit_coefficient_sum(self) -> None:
    ...
    def test_build_model_single_polarity_bool_clause_routes_to_sum(self) -> None:
    ...
    def test_solve_fzn_bool_clause_semantics_are_unchanged(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_unit_coefficient_sum_solves_correctly(self) -> None:
    ...
    def test_solve_fzn_bool_lin_eq_variable_result(self) -> None:
    ...
    def test_solve_fzn_bool_lin_eq_non_unit_coefficients(self) -> None:
    ...
    def test_build_model_bool_lin_eq_negative_unit_coefficients_route_to_sum(self) -> None:
    ...
    def test_solve_fzn_bool_lin_eq_negative_unit_coefficients_solve_correctly(self) -> None:
        out = solve_fzn(
    ...
    def test_build_model_gcc_over_an_unbounded_domain_is_rejected(self) -> None:
    ...
    def test_build_model_gcc_over_a_bounded_domain_is_accepted(self) -> None:
    ...
    def test_solve_fzn_all_different_plus_linear_satisfy(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_element_one_based_offset(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_var_element(self) -> None:
        out = solve_fzn(
            "var 7..7: w0;\nvar 8..8: w1;\nvar 9..9: w2;\n"
    ...
    def test_build_model_var_element_variable_value_uses_element_l_eq(self) -> None:
    ...
    def test_build_model_var_element_constant_value_uses_element_l_eq_c(self) -> None:
    ...
    def test_build_model_element_padded_array_keeps_constants_aligned(self) -> None:
    ...
    def test_build_model_element_index_reaching_zero_falls_back_to_shift(self) -> None:
    ...
    def test_solve_fzn_var_element_constant_value_solves(self) -> None:
    ...
    def test_solve_fzn_gcc_permutation(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_gcc_values_outside_cover_are_unconstrained(self) -> None:
    ...
    def test_solve_fzn_disjunctive(self) -> None:
    ...
    def test_solve_fzn_cumulative(self) -> None:
    ...
    def test_solve_fzn_cumulative_allows_overlap(self) -> None:
    ...
    def test_solve_fzn_cumulative_inconsistent(self) -> None:
    ...
    def test_solve_fzn_diffn(self) -> None:
    ...
    def test_solve_fzn_diffn_inconsistent(self) -> None:
    ...
    def test_solve_fzn_disjunctive_inconsistent(self) -> None:
    ...
    def test_solve_fzn_bool_builtins_and_bool_output(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_table(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_ne(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_lin_ne(self) -> None:
        out = solve_fzn(
            "var 1..2: x :: output_var;\nvar 1..2: y :: output_var;\n"
    ...
    def test_solve_fzn_set_in(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_non_contiguous_var_domain(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_set_in_reif_range_true(self) -> None:
    ...
    def test_solve_fzn_set_in_reif_range_false(self) -> None:
    ...
    def test_solve_fzn_set_in_reif_non_contiguous(self) -> None:
    ...
    def test_solve_fzn_set_in_reif_non_contiguous_is_a_single_propagator(self) -> None:
    ...
    def test_solve_fzn_set_in_reif_non_contiguous_prunes_both_ways(self) -> None:
    ...
    def test_solve_fzn_set_in_reif_derives_reif(self) -> None:
        # x is fixed to 2 which is in 1..3, so b is forced true
        out = solve_fzn("var 2..2: x;\nvar bool: b :: output_var;\nconstraint set_in_reif(x, 1..3, b);\nsolve satisfy;")
        assert "b = true;" in out

    def test_solve_fzn_set_in_reif_used_for_counting(self) -> None:
    ...
    def test_solve_fzn_int_le_reif(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_lt_reif(self) -> None:
        out = solve_fzn(
            "var 0..5: x :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_bool_le_reif_detects_truth_value(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_int_ne_reif(self) -> None:
        out = solve_fzn(
            "var 0..3: x :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_bool_xor_reif(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\nvar bool: r :: output_var;\n"
            "constraint bool_eq(a, true);\nconstraint bool_eq(b, false);\n"
    ...
    def test_solve_fzn_bool_xor_binary(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\n"
    ...
    def test_solve_fzn_bool_or(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\nvar bool: r :: output_var;\n"
            "constraint bool_eq(a, true);\nconstraint bool_eq(b, false);\n"
    ...
    def test_solve_fzn_array_bool_or(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_bool_clause(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\n"
            "constraint bool_eq(a, false);\n"
    ...
    def test_solve_fzn_bool_eq_reif(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\nvar bool: r :: output_var;\n"
            "constraint bool_eq(a, true);\nconstraint bool_eq(b, false);\n"
    ...
    def test_solve_fzn_bool_lin_le(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\n"
            "constraint bool_eq(a, true);\n"
    ...
    def test_solve_fzn_array_bool_element(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_lin_eq_reif(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_lin_le_reif(self) -> None:
        out = solve_fzn(
            "var 0..5: x :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_int_lin_ne_reif(self) -> None:
        out = solve_fzn(
            "var 0..3: x :: output_var;\nvar 0..3: y :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_int_lin_le_reif_binary_difference(self) -> None:
    ...
    def test_solve_fzn_int_lin_le_imp(self) -> None:
    ...
    def test_solve_fzn_int_lin_le_imp_binary_difference(self) -> None:
        # the [1,-1]/[-1,1] difference pattern is posted directly as r -> x <= y + c (no aux variable)
        out = solve_fzn(
            "var 0..9: x :: output_var;\nvar 0..9: y;\nvar bool: r;\n"
            "constraint int_eq(y, 3);\nconstraint bool_eq(r, true);\n"
    ...
    def test_solve_fzn_int_lin_ge_reif_binary_difference(self) -> None:
        out = solve_fzn(
            "var 0..9: x :: output_var;\nvar bool: r :: output_var;\n"
            "constraint int_eq(x, 4);\nvar 0..9: y;\nconstraint int_eq(y, 2);\n"
    ...
    def test_solve_fzn_array_int_maximum_minimum(self) -> None:
        out = solve_fzn(
            "var 0..9: a;\nvar 0..9: b;\nvar 0..9: c;\n"
    ...
    def test_solve_fzn_int_ge_gt(self) -> None:
        out = solve_fzn(
            "var 0..5: x :: output_var;\n"
    ...
    def test_solve_fzn_int_ge_reif(self) -> None:
        out = solve_fzn(
            "var 0..5: x :: output_var;\nvar bool: r :: output_var;\n"
    ...
    def test_solve_fzn_int_lin_ge(self) -> None:
        out = solve_fzn(
            "var 0..5: x :: output_var;\nvar 0..5: y :: output_var;\n"
    ...
    def test_solve_fzn_bool_lt(self) -> None:
        out = solve_fzn(
            "var bool: a :: output_var;\nvar bool: b :: output_var;\n"
    ...
    def test_solve_fzn_count_eq(self) -> None:
        out = solve_fzn(
    ...
    def test_build_model_count_eq_variable_value_unsupported(self) -> None:
    ...
    def test_build_model_count_eq_constant_count_uses_count_eq_c(self) -> None:
    ...
    def test_build_model_count_eq_variable_count_uses_count_eq(self) -> None:
    ...
    def test_solve_fzn_count_geq(self) -> None:
    ...
    def test_build_model_count_geq_maps_to_count_geq_c(self) -> None:
        model = build_model(parse("array [1..3] of var 1..3: x;\nconstraint count_geq(x, 2, 2);\nsolve satisfy;"))
        assert [prop[1] for prop in model.problem.propagators] == [ALG_COUNT_GEQ_C]
        assert model.problem.propagators[0][2] == [2, 2]

    def test_solve_fzn_count_leq_too_many_unsatisfiable(self) -> None:
    ...
    def test_build_model_count_leq_maps_to_count_leq_c(self) -> None:
        model = build_model(parse("array [1..3] of var 1..3: x;\nconstraint count_leq(x, 2, 1);\nsolve satisfy;"))
        assert [prop[1] for prop in model.problem.propagators] == [ALG_COUNT_LEQ_C]
        assert model.problem.propagators[0][2] == [2, 1]

    def test_build_model_count_geq_variable_count_unsupported(self) -> None:
        with pytest.raises(FznUnsupportedError):
            build_model(
                parse("var 0..3: n;\narray [1..3] of var 1..3: x;\nconstraint count_geq(x, 2, n);\nsolve satisfy;")
            )

    def test_build_model_nvalue_maps_to_nvalue(self) -> None:
    ...
    def test_solve_fzn_nvalue_one_forces_all_equal(self) -> None:
    ...
    def test_build_model_value_precede_maps_to_value_precede(self) -> None:
        model = build_model(
    ...
    def test_solve_fzn_value_precede_solves(self) -> None:
    ...
    def test_build_model_lex_less_maps_to_lexleq_with_sentinels(self) -> None:
    ...
    def test_solve_fzn_lex_less_solves(self) -> None:
        from itertools import product
    ...
    def test_solve_fzn_lex_greater_solves_via_swap(self) -> None:
    ...
    def test_build_model_increasing_maps_to_increasing(self) -> None:
    ...
    def test_solve_fzn_increasing_solve(self) -> None:
    ...
    def test_build_model_strictly_increasing_maps_to_strictly_increasing(self) -> None:
        model = build_model(
    ...
    def test_solve_fzn_strictly_increasing_solve(self) -> None:
    ...
    def test_build_model_decreasing_reuses_increasing_on_reversed_list(self) -> None:
    ...
    def test_solve_fzn_decreasing_solve(self) -> None:
    ...
    def test_build_model_strictly_decreasing_reuses_strictly_increasing_on_reversed_list(self) -> None:
        model = build_model(
            parse(
                "var 0..4: a;\nvar 0..4: b;\nvar 0..4: c;\n"
    ...
    def test_solve_fzn_strictly_decreasing_solve(self) -> None:
    ...
    def test_solve_fzn_circuit(self) -> None:
    ...
    def test_solve_fzn_circuit_zero_based(self) -> None:
    ...
    def test_build_model_circuit_uses_variables_directly(self) -> None:
        ...
        # offset: ALLDIFFERENT + CIRCUIT_CHAINS and nothing else, no shifted copies
        for offset, domain in ((0, "0..2"), (1, "1..3"), (-4, "-4..-2")):
            model = build_model(
                parse(f"array [1..3] of var {domain}: x;\nconstraint nucs_circuit(x, {offset});\nsolve satisfy;")
            )
            assert [prop[1] for prop in model.problem.propagators] == [ALG_ALLDIFFERENT, ALG_CIRCUIT_CHAINS]
            assert len(model.problem.domains) == 3
            assert model.problem.propagators[1][2] == [offset]

    def test_solve_fzn_seq_search_annotation(self) -> None:
    ...
    def test_solve_fzn_circuit_self_loop_unsatisfiable(self) -> None:
    ...
    def test_build_model_subcircuit_maps_to_alldifferent_and_subcircuit(self) -> None:
    ...
    def test_solve_fzn_subcircuit_solves_without_duplicates(self) -> None:
    ...
    def test_solve_fzn_subcircuit_two_cycles_unsatisfiable(self) -> None:
    ...
    def test_solve_fzn_inverse(self) -> None:
    ...
    def test_solve_fzn_inverse_infers_both_ways(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_minimize(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_output_objective_dzn(self) -> None:
    ...
    def test_solve_fzn_output_objective_omitted_by_default(self) -> None:
        out = solve_fzn(
            "var 0..9: x :: output_var;\nvar 0..18: z;\n"
    ...
    def test_solve_fzn_output_objective_json(self) -> None:
        out = solve_fzn(
            "var 0..9: x :: output_var;\nvar 0..18: z;\n"
    ...
    def test_solve_fzn_optimization_prints_only_the_optimum_by_default(self) -> None:
    ...
    def test_solve_fzn_optimization_streams_improving_solutions_on_request(
        self, all_solutions: bool, intermediate: bool
    ) -> None:
    ...
    def test_solve_fzn_alias_declaration_narrows_its_right_hand_side(self) -> None:
    ...
    def test_solve_fzn_alias_declaration_does_not_widen_its_right_hand_side(self) -> None:
    ...
    def test_solve_fzn_alias_declaration_with_a_disjoint_domain_is_unsatisfiable(self) -> None:
    ...
    def test_solve_fzn_alias_declaration_domain_reaches_the_other_constraints(self) -> None:
    ...
    def test_build_model_unit_linear_equality_is_absorbed_as_an_alias(self) -> None:
    ...
    def test_build_model_offset_linear_equality_is_not_absorbed(self) -> None:
    ...
    def test_solve_fzn_unit_linear_equality_alias_keeps_the_solution_set(self) -> None:
    ...
    def test_build_model_statistics_go_to_the_solution_stream(self) -> None:
    ...
    def test_build_arg_parser_cli_parses_output_options(self) -> None:
    ...
    def test_solve_fzn_time_limit_reports_unknown_when_nothing_is_found(self) -> None:
    ...
    def test_parse_args_cli_parses_intermediate_solutions(self) -> None:
        from nucs.fzn.__main__ import build_arg_parser
    ...
    def test_parse_args_cli_output_mode_defaults_to_item(self) -> None:
        from nucs.fzn.__main__ import build_arg_parser
    ...
    def test_build_model_search_heuristics_maps_int_search(self) -> None:
    ...
    def test_build_model_search_heuristics_maps_indomain_random(self) -> None:
        model = build_model(
    ...
    def test_build_model_search_heuristics_maps_smallest_and_largest(self) -> None:
    ...
    def test_solve_fzn_search_annotation_value_heuristic_changes_first_solution(self) -> None:
        out = solve_fzn(
    ...
    def test_build_model_search_heuristics_maps_reverse_split(self) -> None:
        model = build_model(
    ...
    def test_build_model_search_heuristics_seq_search_keeps_groups_and_appends_catch_all(self) -> None:
    ...
    def test_build_model_search_heuristics_flattens_nested_seq_search(self) -> None:
    ...
    def test_solve_fzn_search_annotation_reverse_split_takes_upper_half_first(self) -> None:
        out = solve_fzn(
            "var 0..3: x :: output_var;\n"
            "solve :: int_search([x], input_order, indomain_reverse_split, complete) satisfy;"
        )
    ...
    def test_solve_fzn_all_solutions_terminator(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_unsatisfiable(self) -> None:
        out = solve_fzn("var 1..2: x :: output_var;\nconstraint int_eq(x, 5);\nsolve satisfy;")
        assert out.strip() == "=====UNSATISFIABLE====="

    def test_build_model_unsupported_builtin(self) -> None:
        with pytest.raises(FznUnsupportedError):
            build_model(parse("var 0..1: x;\nvar 0..1: y;\nconstraint int_pow(x, y, x);\nsolve satisfy;"))

    def test_solve_fzn_var_times_var(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_mod(self) -> None:
        out = solve_fzn(
    ...
    def test_solve_fzn_int_mod_negative_dividend(self) -> None:
    ...
    def test_build_model_int_mod_constant_divisor_uses_mod_c_eq(self) -> None:
    ...
    def test_build_model_int_mod_variable_divisor_uses_mod_eq(self) -> None:
        model = build_model(
            parse("var 0..9: x;\nvar 1..9: y;\nvar -9..9: z;\nconstraint int_mod(x, y, z);\nsolve satisfy;")
        )
        assert [prop[1] for prop in model.problem.propagators] == [ALG_MOD_EQ]

    def test_solve_fzn_int_mod_constant_divisor_prunes_dividend(self) -> None:
