...
class TestParser:
    def test_parse_par_decls(self) -> None:
    ...
    def test_parse_constraint_and_solve(self) -> None:
    ...
    def test_parse_satisfy_and_comments(self) -> None:
        (solve,) = parse("% a comment\nsolve satisfy; % trailing\n")
        assert solve == Solve("satisfy", None)

    def test_parse_solve_search_annotation_is_kept(self) -> None:
    ...
    def test_parse_predicate_ignored(self) -> None:
        statements = parse("predicate foo(var int: x);\nsolve satisfy;")
        assert statements == [Solve("satisfy", None)]

    def test_parse_unsupported_float(self) -> None:
    ...
    def test_parse_unsupported_float_literal(self, text: str) -> None:
    ...
    def test_parse_float_rejection_keeps_range_punctuation(self) -> None:
    ...
    def test_parse_non_contiguous_set_domain(self) -> None:
    ...
    def test_parse_set_literal_term(self) -> None:
