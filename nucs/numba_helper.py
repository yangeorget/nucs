...
# an advisor takes a compute_domains function's arguments (prop_domains, parameters) but returns a bool
AdvisorFunctions = Sequence[Callable[[NDArray, NDArray], bool]]
