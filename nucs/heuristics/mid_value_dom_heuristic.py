...
@njit(cache=True)
def mid_value_dom_heuristic(domains: NDArray, variable: int, params: NDArray) -> tuple[int, int]:
    """
    ...
    :rtype: Tuple[int, int]
    """
    return DECISION_EQ, (domains[variable, DOMAIN_MIN] + domains[variable, DOMAIN_MAX]) >> 1
