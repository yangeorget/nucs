...
from nucs.constants import DECISION_LE, DECISION_VALUE, MIN


@njit(cache=True)
def min_value_dom_heuristic(domains: NDArray, variable: int, params: NDArray, decision: NDArray) -> int:
    """
    ...
    :rtype: int
    """
    decision[DECISION_VALUE] = domains[variable, MIN]
    return DECISION_LE
