...
def get_state_sum_eq_c(n: int, parameters: Sequence[int]) -> tuple[int, int]:
    """
...
@njit(cache=True)
def compute_domains_sum_eq_c(domains: NDArray, parameters: NDArray, prop_state: NDArray) -> int:
    """
