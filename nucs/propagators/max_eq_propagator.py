...
@njit(cache=True)
def compute_domains_max_eq(domains: NDArray, parameters: NDArray, prop_state: NDArray) -> int:
    """
    ...
    # No x_i may exceed y, so cap every x_i[DOMAIN_MAX] at y_max. The maximum y can take any value in
