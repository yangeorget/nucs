...
def get_complexity_count_geq_c(n: int, parameters: NDArray) -> float:
    """
...
@njit(cache=True)
def get_triggers_count_geq_c(n: int, dom_idx: int, parameters: NDArray) -> int:
    """
...
@njit(cache=True)
def compute_domains_count_geq_c(domains: NDArray, parameters: NDArray) -> int:
    """
