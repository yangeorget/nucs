...
def get_complexity_element_liv_alldifferent(n: int, parameters: NDArray) -> float:
    """
...
def get_triggers_element_liv_alldifferent(n: int, parameters: NDArray) -> NDArray:
    """
...
@njit(cache=True)
def compute_domains_element_liv_alldifferent(domains: NDArray, parameters: NDArray) -> int:
    """
