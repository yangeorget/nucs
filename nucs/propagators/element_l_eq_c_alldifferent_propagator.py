...
def get_complexity_element_l_eq_c_alldifferent(n: int, parameters: NDArray) -> float:
    """
...
@njit(cache=True)
def get_triggers_element_l_eq_c_alldifferent(n: int, dom_idx: int, parameters: NDArray) -> int:
    """
