...
def get_state_element_l_eq(n: int, parameters: Sequence[int]) -> tuple[int, int]:
    """
...
@njit(cache=True)
def compute_domains_element_l_eq(domains: NDArray, parameters: NDArray, prop_state: NDArray) -> int:
    """
    Enforces :math:`l_i = v`.
    ...
    # i and v are the only domains this can narrow, and old_v_min/old_v_max below already snapshot v
