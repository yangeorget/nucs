...
def get_statistics(stats: Union[NDArray, List[NDArray]]) -> Dict[str, int]:
    ...
    if isinstance(stats, list):
        return {
            ...
            STATS_LBL_PROBLEM_SHAVING_NB: sum_stats(stats, STATS_IDX_PROBLEM_SHAVING_NB),
            STATS_LBL_PROBLEM_SHAVING_CHANGE_NB: sum_stats(stats, STATS_IDX_PROBLEM_SHAVING_CHANGE_NB),
            STATS_LBL_PROBLEM_SHAVING_NO_CHANGE_NB: sum_stats(stats, STATS_IDX_PROBLEM_SHAVING_NO_CHANGE_NB),
        ...
        return {
            ...
            STATS_LBL_PROBLEM_SHAVING_NB: int(stats[STATS_IDX_PROBLEM_SHAVING_NB]),
            STATS_LBL_PROBLEM_SHAVING_CHANGE_NB: int(stats[STATS_IDX_PROBLEM_SHAVING_CHANGE_NB]),
            STATS_LBL_PROBLEM_SHAVING_NO_CHANGE_NB: int(stats[STATS_IDX_PROBLEM_SHAVING_NO_CHANGE_NB]),
...
STATS_LBL_PROBLEM_SHAVING_NB = "PROBLEM_SHAVING_NB"
STATS_LBL_PROBLEM_SHAVING_CHANGE_NB = "PROBLEM_SHAVING_CHANGE_NB"
STATS_LBL_PROBLEM_SHAVING_NO_CHANGE_NB = "PROBLEM_SHAVING_NO_CHANGE_NB"
